...
function! s:DefxCopyFile(_) abort
  if !executable('xclip-copyfile') && !g:is_win
    echohl WarningMsg
...
function! s:DefxPasteFile(_) abort
  if !executable('xclip-pastefile') && !g:is_win
    echohl WarningMsg
    echo 'you need to have xclip-copyfile in your PATH'
    echohl NONE
    return
